...
//   <div className="inline-block animate-float mx-auto lg:mx-0 mt-2" data-aos="zoom-in" data-aos-delay="400">
...
const TechStack = memo(({ tech }) => (
  <div className="px-3 py-1 sm:px-4 sm:py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-xs sm:text-sm text-gray-300 hover:bg-white/10 transition-colors">
    {tech}
  </div>
));
...
const WORDS = ["DevOps Enthusiast", "AI Explorer"];
const TECH_STACK = ["React", "Tailwind", "Laravel", "Express", "Node.js", "PostgreSQL", "MongoDB"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/AliAlYaman" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ali-al-yaman-b881b7314/" }
];
    ...
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between h-full py-16 lg:py-0 lg:h-screen gap-8 sm:gap-12 lg:gap-8 xl:gap-20">
            {/* Left Column */}
            <div className="w-full lg:w-1/2 space-y-4 sm:space-y-6 md:space-y-8 text-center lg:text-left order-2 lg:order-1 mt-0 lg:mt-0"
              data-aos="fade-right"
              data-aos-delay="200">
              <div className="space-y-3 sm:space-y-4 md:space-y-6">
                ...
                {/* Description */}
                <p className="text-sm sm:text-base md:text-lg text-gray-400 max-w-md sm:max-w-xl leading-relaxed font-light mx-auto lg:mx-0"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building scalable backend systems for tomorrow's challenges - powered by clean code, DevOps automation, and AI integration.
                </p>
                ...
                {/* Social Links */}
                <div className="flex gap-2 sm:gap-4 justify-center lg:justify-start" data-aos="fade-up" data-aos-delay="1600">
            ...
            <div className="w-full sm:w-4/5 md:w-2/3 lg:w-1/2 h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-1 lg:order-2 mt-0 lg:mt-0"
              ...
              <div className="relative w-full opacity-90">
                ...
                <div className={`absolute inset-0 pointer-events-none transition-all duration-700 ${
                  ...
                  <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] sm:w-[300px] sm:h-[300px] md:w-[400px] md:h-[400px] bg-gradient-to-br from-indigo-500/10 to-purple-500/10 blur-3xl animate-[pulse_6s_cubic-bezier(0.4,0,0.6,1)_infinite] transition-all duration-700 ${
